...
abstract class $BaseResponseCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({num code, String msg, num timestamp, T? data});
}
...
class _$BaseResponseImpl<T> implements _BaseResponse<T> {
  const _$BaseResponseImpl(
      {this.code = -1, this.msg = '', this.timestamp = -1, this.data});
  ...
  @override
  String toString() {
    return 'BaseResponse<$T>(code: $code, msg: $msg, timestamp: $timestamp, data: $data)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, code, msg, timestamp,
